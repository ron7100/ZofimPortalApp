...
namespace ZofimPortalApp.Services
{
    class ZofimPortalAPIProxy
    {
        ...
        private const string DEV_ANDROID_EMULATOR_URL = "http://10.0.2.2:21604/ZofimPortalAPI"; //API url when using emulator on android
        private const string DEV_ANDROID_PHYSICAL_URL = "http://192.168.1.14:21604/ZofimPortalAPI"; //API url when using physucal device on android
        private const string DEV_WINDOWS_URL = "https://localhost:44331/ZofimPortalAPI"; //API url when using windoes on development
